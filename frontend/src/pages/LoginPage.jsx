...
const LoginPage = () => {
  ...
  return (
    <div className="flex w-full min-h-screen overflow-hidden relative bg-gray-500 bg-cover bg-center">
      {/* Image Section */}
      <div
      ...
      >
        <div className="relative w-full h-full">
          <img src={background} alt="Secure Login" className="w-full h-full object-cover" />
          <div className="absolute inset-0 bg-black/40"></div> {/* Darker Overlay */}
        </div>
      </div>
      ...
      <div
        ...
        style={{ zIndex: 2 }}
      >
        <div className="w-full max-w-lg px-6 mt-12 md:mt-20">
          <Login />
        </div>
      </div>
    </div>
